...
Description: Adds a calculator component to your WordPress site.
Version: 1.0
Author: Konrad Kubrak
*/

// Enqueue CSS and JS files
function calculator_enqueue_scripts()
{
  wp_enqueue_style('calculator-style', plugin_dir_url(__FILE__) . 'css/calculator.css');
  wp_enqueue_script('calculator-script', plugin_dir_url(__FILE__) . 'js/calculator.js', array(), '1.0', true);
}

add_action('wp_enqueue_scripts', 'calculator_enqueue_scripts');
